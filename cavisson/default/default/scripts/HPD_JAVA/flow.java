/*-----------------------------------------------------------------------------
    ...
    Date of recording: 07/02/2021 02:23:27
    Flow details:
    Build details: 4.6.1 (build# 32)
...
public class flow implements NsFlow
{
    public int execute(NSApi nsApi) throws Exception
    {
        ...
        status = nsApi.ns_page_think_time(16.635);

        //Page Auto split for Image Link 'Login' Clicked by User
        status = nsApi.ns_start_transaction("login");
        status = nsApi.ns_web_url ("login",
            "URL=https://10.10.30.207:8443/cgi-bin/login?userSession=75893.0884568651DQADHfApHDHfcDtccpfAttcf&username=cavisson&password=cavisson&login.x=66&login.y=18&JSFormSubmit=off",
            "HEADER=Upgrade-Insecure-Requests:1",
        ...
        status = nsApi.ns_page_think_time(2.661);
        ...
        status = nsApi.ns_page_think_time(4.481);
        ...
        status = nsApi.ns_web_url ("findflight",
            "URL=https://10.10.30.207:8443/cgi-bin/findflight?depart=Acapulco&departDate=07-03-2021&arrive=Acapulco&returnDate=07-04-2021&numPassengers=1&seatPref=None&seatType=Coach&findFlights.x=82&findFlights.y=6",
            "HEADER=Upgrade-Insecure-Requests:1",
            "HEADER=Sec-Fetch-Site:same-origin",
            "HEADER=Sec-Fetch-Mode:navigate",
            "HEADER=Sec-Fetch-User:?1",
        ...
        status = nsApi.ns_page_think_time(1.195);
        ...
        status = nsApi.ns_web_url ("findflight_2",
            "URL=https://10.10.30.207:8443/cgi-bin/findflight?outboundFlight=button0&hidden_outboundFlight_button0=000%7C0%7C07-03-2021&hidden_outboundFlight_button1=001%7C0%7C07-03-2021&hidden_outboundFlight_button2=002%7C0%7C07-03-2021&hidden_outboundFlight_button3=003%7C0%7C07-03-2021&numPassengers=1&advanceDiscount=&seatType=Coach&seatPref=None&reserveFlights.x=91&reserveFlights.y=10",
            "HEADER=Upgrade-Insecure-Requests:1",
            "HEADER=Sec-Fetch-Site:same-origin",
            "HEADER=Sec-Fetch-Mode:navigate",
            "HEADER=Sec-Fetch-User:?1",
        ...
        status = nsApi.ns_page_think_time(2.372);
        ...
        status = nsApi.ns_web_url ("findflight_3",
            "URL=https://10.10.30.207:8443/cgi-bin/findflight?firstName=Tiger&lastName=Scott&address1=4261+Stevenson+Blvd.&address2=Fremont%2C+CA+94538&pass1=Scott+Tiger&creditCard=&expDate=&oldCCOption=&numPassengers=1&seatType=Coach&seatPref=None&outboundFlight=000%7C0%7C07-03-2021&advanceDiscount=&buyFlights.x=69&buyFlights.y=11&.cgifields=saveCC",
            "HEADER=Upgrade-Insecure-Requests:1",
            "HEADER=Sec-Fetch-Site:same-origin",
            "HEADER=Sec-Fetch-Mode:navigate",
            "HEADER=Sec-Fetch-User:?1",
        ...
        status = nsApi.ns_page_think_time(1.65);
        ...
        status = nsApi.ns_page_think_time(1.516);
